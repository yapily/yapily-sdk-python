...
class PreAuthorisationRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, institution_id, scope, *args, **kwargs):  # noqa: E501
        """PreAuthorisationRequest - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, institution_id, scope, *args, **kwargs):  # noqa: E501
        """PreAuthorisationRequest - a model defined in OpenAPI
