...
class EventSubscriptionResponse(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, event_type_id, application_id, created, notification, *args, **kwargs):  # noqa: E501
        """EventSubscriptionResponse - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, event_type_id, application_id, created, notification, *args, **kwargs):  # noqa: E501
        """EventSubscriptionResponse - a model defined in OpenAPI
