...
class BulkPaymentEmbeddedAuthorisationRequest(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'payment_request': (BulkPaymentRequest,),  # noqa: E501
    ...
    def _from_openapi_data(cls, institution_id, *args, **kwargs):  # noqa: E501
        """BulkPaymentEmbeddedAuthorisationRequest - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            user_uuid (str): __Conditional__. The reference to the `User` that will authorise the authorisation request using the Yapily generated UUID. Either the `userUuid` or `applicationUserId` must be provided.. [optional]  # noqa: E501
            ...
            payment_request (BulkPaymentRequest): [optional]  # noqa: E501
