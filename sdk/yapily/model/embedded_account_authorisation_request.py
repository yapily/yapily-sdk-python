...
class EmbeddedAccountAuthorisationRequest(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'user_credentials': (UserCredentials,),  # noqa: E501
            'selected_sca_method': (ScaMethod,),  # noqa: E501
            'sca_code': (str,),  # noqa: E501
            'account_request': (AccountRequest,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, institution_id, *args, **kwargs):  # noqa: E501
        """EmbeddedAccountAuthorisationRequest - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            user_uuid (str): `User` for which the authorisation request was created.. [optional]  # noqa: E501
            ...
            callback (str): __Optional__. The server to redirect the user to after the user complete the authorisation at the `Institution`. <br><br>See [Using a callback (Optional)](https://docs.yapily.com/) for more information.. [optional]  # noqa: E501
