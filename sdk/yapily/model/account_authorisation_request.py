...
class AccountAuthorisationRequest(ModelNormal):
    ...
    def _from_openapi_data(cls, institution_id, *args, **kwargs):  # noqa: E501
        """AccountAuthorisationRequest - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            callback (str): __Optional__. The server to redirect the user to after the user completes the authorisation at the `Institution`. <br><br>See [Using a callback (Optional)](https://docs.yapily.com/pages/knowledge/yapily-concepts/callback_url/#using-a-callback-optional) for more information.. [optional]  # noqa: E501
