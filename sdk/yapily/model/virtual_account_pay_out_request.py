...
class VirtualAccountPayOutRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, account_id, amount, reference, beneficiary_id, payment_scheme, *args, **kwargs):  # noqa: E501
        """VirtualAccountPayOutRequest - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            payment_date (date): Date on which a payment instruction will be executed, that must be in the future. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, account_id, amount, reference, beneficiary_id, payment_scheme, *args, **kwargs):  # noqa: E501
        """VirtualAccountPayOutRequest - a model defined in OpenAPI
