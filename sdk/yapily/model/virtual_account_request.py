...
class VirtualAccountRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, nickname, currency, *args, **kwargs):  # noqa: E501
        """VirtualAccountRequest - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, nickname, currency, *args, **kwargs):  # noqa: E501
        """VirtualAccountRequest - a model defined in OpenAPI
