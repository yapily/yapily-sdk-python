...
class PayeeDetails(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, account_identifications, country, *args, **kwargs):  # noqa: E501
        """PayeeDetails - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, account_identifications, country, *args, **kwargs):  # noqa: E501
        """PayeeDetails - a model defined in OpenAPI
