...
class AccountsApi(object):
    ...
    def get_account_periodic_payment_order_using_get(self, account_id, consent, **kwargs):  # noqa: E501
        """Get account payments detail  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_account_periodic_payment_order_using_get(account_id, consent, async=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.get_account_periodic_payment_order_using_get_with_http_info(account_id, consent, **kwargs)  # noqa: E501
        else:
            (data) = self.get_account_periodic_payment_order_using_get_with_http_info(account_id, consent, **kwargs)  # noqa: E501
            return data

    def get_account_periodic_payment_order_using_get_with_http_info(self, account_id, consent, **kwargs):  # noqa: E501
        """Get account payments detail  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_account_periodic_payment_order_using_get_with_http_info(account_id, consent, async=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_account_periodic_payment_order_using_get" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'account_id' is set
        if ('account_id' not in params or
                params['account_id'] is None):
            raise ValueError("Missing the required parameter `account_id` when calling `get_account_periodic_payment_order_using_get`")  # noqa: E501
        # verify the required parameter 'consent' is set
        if ('consent' not in params or
                params['consent'] is None):
            raise ValueError("Missing the required parameter `consent` when calling `get_account_periodic_payment_order_using_get`")  # noqa: E501
