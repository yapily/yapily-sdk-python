...
class FinancialDataApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_real_time_transactions_endpoint = _Endpoint(
            settings={
                'response_type': (ApiListResponseOfRealTimeTransaction,),
                'auth': [
                    'basicAuth'
                ],
                'endpoint_path': '/accounts/{accountId}/real-time/transactions',
                'operation_id': 'get_real_time_transactions',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def get_real_time_transactions(
        ...
        **kwargs
        ...
        >>> thread = api.get_real_time_transactions(account_id, consent, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['consent'] = \
            consent
        return self.get_real_time_transactions_endpoint.call_with_http_info(**kwargs)
