...
class EmbeddedPaymentsApi(object):
    ...
    def create_embedded_bulk_payment_authorisation_using_post(self, bulk_payment_embedded_authorisation_request, **kwargs):  # noqa: E501
        """Initiate an embedded bulk payment for user to authorise  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_embedded_bulk_payment_authorisation_using_post(bulk_payment_embedded_authorisation_request, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param BulkPaymentEmbeddedAuthorisationRequest bulk_payment_embedded_authorisation_request: bulkPaymentEmbeddedAuthorisationRequest (required)
        ...
        return self.create_embedded_bulk_payment_authorisation_using_post_with_http_info(bulk_payment_embedded_authorisation_request, **kwargs)  # noqa: E501

    def create_embedded_bulk_payment_authorisation_using_post_with_http_info(self, bulk_payment_embedded_authorisation_request, **kwargs):  # noqa: E501
        """Initiate an embedded bulk payment for user to authorise  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_embedded_bulk_payment_authorisation_using_post_with_http_info(bulk_payment_embedded_authorisation_request, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method create_embedded_bulk_payment_authorisation_using_post" % key
                )
        ...
        if self.api_client.client_side_validation and ('bulk_payment_embedded_authorisation_request' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `bulk_payment_embedded_authorisation_request` when calling `create_embedded_bulk_payment_authorisation_using_post`")  # noqa: E501
    ...
    def update_embedded_bulk_payment_authorisation_using_put(self, consent_id, bulk_payment_embedded_authorisation_request, **kwargs):  # noqa: E501
        """Update an embedded bulk payment initiation with SCA info  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_embedded_bulk_payment_authorisation_using_put(consent_id, bulk_payment_embedded_authorisation_request, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.update_embedded_bulk_payment_authorisation_using_put_with_http_info(consent_id, bulk_payment_embedded_authorisation_request, **kwargs)  # noqa: E501

    def update_embedded_bulk_payment_authorisation_using_put_with_http_info(self, consent_id, bulk_payment_embedded_authorisation_request, **kwargs):  # noqa: E501
        """Update an embedded bulk payment initiation with SCA info  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_embedded_bulk_payment_authorisation_using_put_with_http_info(consent_id, bulk_payment_embedded_authorisation_request, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_embedded_bulk_payment_authorisation_using_put" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        ...
        if self.api_client.client_side_validation and ('consent_id' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `consent_id` when calling `update_embedded_bulk_payment_authorisation_using_put`")  # noqa: E501
        # verify the required parameter 'bulk_payment_embedded_authorisation_request' is set
        if self.api_client.client_side_validation and ('bulk_payment_embedded_authorisation_request' not in local_var_params or  # noqa: E501
                                                        local_var_params['bulk_payment_embedded_authorisation_request'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `bulk_payment_embedded_authorisation_request` when calling `update_embedded_bulk_payment_authorisation_using_put`")  # noqa: E501
