...
class PaymentsApi(object):
    ...
    def create_payment_initiation_using_post(self, **kwargs):  # noqa: E501
        """Initiate a new single payment for user to authorise  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.create_payment_initiation_using_post(async=True)
        >>> result = thread.get()

        :param async bool
        :param SortCodePaymentAuthRequest payment_auth_request: paymentAuthRequest
        ...
        if kwargs.get('async'):
            return self.create_payment_initiation_using_post_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.create_payment_initiation_using_post_with_http_info(**kwargs)  # noqa: E501
            return data

    def create_payment_initiation_using_post_with_http_info(self, **kwargs):  # noqa: E501
        """Initiate a new single payment for user to authorise  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.create_payment_initiation_using_post_with_http_info(async=True)
        >>> result = thread.get()
