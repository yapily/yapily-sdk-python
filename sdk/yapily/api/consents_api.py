...
class ConsentsApi(object):
    ...
    def get_consents_using_get(self, **kwargs):  # noqa: E501
        ...
        :param async bool
        :param str filter_application_user_id: Filter consents by applicationUserId
        :param str filter_user_uuid: Filter consents by userUuid
        :param str filter_institution: Use this parameter to filter consent by institution, using the Yapily institution Id
    ...
    def get_consents_using_get_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['filter_application_user_id', 'filter_user_uuid', 'filter_institution']  # noqa: E501
        all_params.append('async')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def get_user_consents_using_get_with_http_info(self, user_uuid, **kwargs):  # noqa: E501
        ...
        all_params = ['user_uuid', 'filter_institution']  # noqa: E501
        all_params.append('async')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
