...
class InstitutionsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_feature_details_endpoint = _Endpoint(
            settings={
                'response_type': (ApiListResponseOfFeatureDetails,),
                'auth': [
                    'basicAuth'
                ],
                'endpoint_path': '/features',
                'operation_id': 'get_feature_details',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_institution_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/institutions/{institutionId}',
        ...
        self.get_institutions_endpoint = _Endpoint(
            settings={
                'response_type': (ApiListResponseOfInstitution,),
                'auth': [
                    'basicAuth'
                ],
    ...
    def get_feature_details(
        ...
        **kwargs
        ...
        return self.get_feature_details_endpoint.call_with_http_info(**kwargs)
