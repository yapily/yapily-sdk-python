...
class BalancesApi(object):
    ...
    def get_account_balances_using_get(self, consent, account_id, **kwargs):  # noqa: E501
        """Get account balances  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_account_balances_using_get(consent, account_id, async_req=True)
        >>> result = thread.get()
        ...
        return self.get_account_balances_using_get_with_http_info(consent, account_id, **kwargs)  # noqa: E501

    def get_account_balances_using_get_with_http_info(self, consent, account_id, **kwargs):  # noqa: E501
        """Get account balances  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_account_balances_using_get_with_http_info(consent, account_id, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('consent' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `consent` when calling `get_account_balances_using_get`")  # noqa: E501
