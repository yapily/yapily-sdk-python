...
from yapily.exceptions import ApiTypeError, ApiValueError, ApiException
from yapily.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.get_application_me  # this is an instance of the class Endpoint
        api_instance.get_application_me()  # this invokes api_instance.get_application_me.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_application_me.callable or self.callable in this class
