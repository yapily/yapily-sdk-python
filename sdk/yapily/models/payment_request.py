...
from yapily.models.payer import Payer  # noqa: F401,E501
...
class PaymentRequest(object):
    ...
    def __init__(self, payment_idempotency_id=None, payer=None, amount=None, reference=None, context_type=None, type=None, payment_date_time=None, payee=None, periodic_payment=None, international_payment=None):  # noqa: E501
    ...
    def type(self, type):
        ...
        allowed_values = ["DOMESTIC_PAYMENT", "DOMESTIC_VARIABLE_RECURRING_PAYMENT", "DOMESTIC_SCHEDULED_PAYMENT", "DOMESTIC_PERIODIC_PAYMENT", "INTERNATIONAL_PAYMENT", "INTERNATIONAL_SCHEDULED_PAYMENT", "INTERNATIONAL_PERIODIC_PAYMENT", "BULK_PAYMENT"]  # noqa: E501
