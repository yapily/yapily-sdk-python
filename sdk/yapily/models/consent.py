...
class Consent(object):
    ...
    def __init__(self, id=None, user_uuid=None, reference_id=None, institution_id=None, status=None, created_at=None, transaction_from=None, transaction_to=None, expires_at=None, time_to_expire_in_millis=None, time_to_expire=None, feature_scope=None, consent_token=None):  # noqa: E501
