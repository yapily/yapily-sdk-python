...
class Consent(object):
    ...
    def __init__(self, application_user_id=None, authorized_at=None, consent_token=None, created_at=None, expires_at=None, feature_scope=None, id=None, institution_consent_id=None, institution_id=None, reference_id=None, state=None, status=None, time_to_expire=None, time_to_expire_in_millis=None, transaction_from=None, transaction_to=None, user_uuid=None, local_vars_configuration=None):  # noqa: E501
