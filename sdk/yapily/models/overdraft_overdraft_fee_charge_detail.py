...
from yapily.models.overdraft_fee_applicable_range import OverdraftFeeApplicableRange  # noqa: F401,E501
...
class OverdraftOverdraftFeeChargeDetail(object):
    ...
    def __init__(self, application_frequency=None, calculation_frequency=None, fee_amount=None, fee_rate=None, fee_rate_type=None, fee_type=None, incremental_borrowing_amount=None, notes=None, other_application_frequency=None, other_calculation_frequency=None, other_fee_rate_type=None, other_fee_type=None, overdraft_control_indicator=None, overdraft_fee_applicable_range=None):  # noqa: E501
        ...
        self._overdraft_fee_applicable_range = None
        ...
        if overdraft_fee_applicable_range is not None:
            self.overdraft_fee_applicable_range = overdraft_fee_applicable_range
    ...
    @property
    def overdraft_fee_applicable_range(self):
        """Gets the overdraft_fee_applicable_range of this OverdraftOverdraftFeeChargeDetail.  # noqa: E501


        :return: The overdraft_fee_applicable_range of this OverdraftOverdraftFeeChargeDetail.  # noqa: E501
        :rtype: OverdraftFeeApplicableRange
        """
        return self._overdraft_fee_applicable_range

    @overdraft_fee_applicable_range.setter
    def overdraft_fee_applicable_range(self, overdraft_fee_applicable_range):
        """Sets the overdraft_fee_applicable_range of this OverdraftOverdraftFeeChargeDetail.


        :param overdraft_fee_applicable_range: The overdraft_fee_applicable_range of this OverdraftOverdraftFeeChargeDetail.  # noqa: E501
        :type: OverdraftFeeApplicableRange
        """

        self._overdraft_fee_applicable_range = overdraft_fee_applicable_range
