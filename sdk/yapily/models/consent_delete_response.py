...
class ConsentDeleteResponse(object):
    ...
    def __init__(self, creation_date=None, delete_status=None, id=None, institution_consent_id=None, institution_id=None, local_vars_configuration=None):  # noqa: E501
