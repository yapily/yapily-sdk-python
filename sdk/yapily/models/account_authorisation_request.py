...
class AccountAuthorisationRequest(object):
    ...
    def __init__(self, referenced_based=None, user_uuid=None, reference_id=None, institution_id=None, account_request=None, callback=None, one_time_token=None):  # noqa: E501
