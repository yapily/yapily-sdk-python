...
class AccountAuthorisationRequest(object):
    ...
    def __init__(self, user_uuid=None, application_user_id=None, forward_parameters=None, institution_id=None, callback=None, redirect=None, account_request=None, one_time_token=None, local_vars_configuration=None):  # noqa: E501
