...
class AuthorisationRequestResponse(object):
    ...
    def __init__(self, id=None, user_uuid=None, institution_id=None, status=None, created_at=None, expires_at=None, time_to_expire_in_millis=None, feature_scope=None, authorisation_url=None, consent_token=None):  # noqa: E501
