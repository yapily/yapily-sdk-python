...
from yapily.models.exchange_rate_information import ExchangeRateInformation  # noqa: F401,E501
...
class InternationalPaymentRequest(object):
    ...
    def __init__(self, currency_of_transfer=None, exchange_rate_information=None, purpose=None, priority=None, charge_bearer=None):  # noqa: E501
        """InternationalPaymentRequest - a model defined in Swagger"""  # noqa: E501
    ...
    def currency_of_transfer(self, currency_of_transfer):
        ...
        :type: str
        """
        if currency_of_transfer is None:
