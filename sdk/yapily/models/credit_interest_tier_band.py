...
from yapily.models.other_bank_interest_type import OtherBankInterestType  # noqa: F401,E501
...
class CreditInterestTierBand(object):
    ...
    def __init__(self, aer=None, application_frequency=None, bank_interest_rate_type=None, calculation_frequency=None, deposit_interest_applied_coverage=None, fixed_variable_interest_rate_type=None, identification=None, notes=None, other_application_frequency=None, other_bank_interest_type=None, other_calculation_frequency=None, tier_value_maximum=None, tier_value_minimum=None):  # noqa: E501
        """CreditInterestTierBand - a model defined in Swagger"""  # noqa: E501
    ...
    def bank_interest_rate_type(self, bank_interest_rate_type):
        ...
        if bank_interest_rate_type not in allowed_values:
            raise ValueError(
    ...
    def deposit_interest_applied_coverage(self, deposit_interest_applied_coverage):
        ...
        if deposit_interest_applied_coverage not in allowed_values:
            raise ValueError(
    ...
    def fixed_variable_interest_rate_type(self, fixed_variable_interest_rate_type):
        ...
        if fixed_variable_interest_rate_type not in allowed_values:
            raise ValueError(
