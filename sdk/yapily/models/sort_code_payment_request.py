...
class SortCodePaymentRequest(object):
    ...
    def __init__(self, sender_account_id=None, name=None, amount=None, currency=None, reference=None, country=None, type=None, account_number=None, sort_code=None, merchant_info=None, local_vars_configuration=None):  # noqa: E501
