...
class Institution(object):
    ...
    def __init__(self, countries=None, credentials_type=None, environment_type=None, features=None, full_name=None, id=None, media=None, monitoring=None, name=None, local_vars_configuration=None):  # noqa: E501
