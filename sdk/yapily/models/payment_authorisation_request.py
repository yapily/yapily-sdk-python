...
class PaymentAuthorisationRequest(object):
    ...
    def __init__(self, user_uuid=None, application_user_id=None, forward_parameters=None, institution_id=None, callback=None, one_time_token=None, total_max_amount=None, total_max_amount_frequency=None, max_amount_per_request=None, starts_at=None, expires_at=None, allow_overdraft=None, payment_request=None):  # noqa: E501
