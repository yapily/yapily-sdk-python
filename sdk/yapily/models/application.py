...
class Application(object):
    ...
    def __init__(self, active=None, auth_callbacks=None, created=None, institutions=None, media=None, name=None, updated=None, uuid=None, local_vars_configuration=None):  # noqa: E501
