...
class AccountsApi(object):
    ...
    def get_account_using_get(self, account_id, consent, **kwargs):  # noqa: E501
        ...
        >>> thread = api.get_account_using_get(account_id, consent, async=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async'):
            ...
            (data) = self.get_account_using_get_with_http_info(account_id, consent, **kwargs)  # noqa: E501
            return data
    ...
    def get_account_using_get_with_http_info(self, account_id, consent, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_account_using_get_with_http_info(account_id, consent, async=True)
        >>> result = thread.get()
        ...
        all_params = ['account_id', 'consent']  # noqa: E501
