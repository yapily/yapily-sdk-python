...
class TestPaymentsApi(unittest.TestCase):
    ...
    def test_create_payment_initiation_using_post(self):
        """Test case for create_payment_initiation_using_post
    ...
    def test_get_payment_initiation_status_using_get(self):
        """Test case for get_payment_initiation_status_using_get
