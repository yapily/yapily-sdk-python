...
*ConsentsApi* | [**get_consent_by_single_access_consent_using_post**](docs/ConsentsApi.md#get_consent_by_single_access_consent_using_post) | **POST** /consents/one-time-token | Post one time token
